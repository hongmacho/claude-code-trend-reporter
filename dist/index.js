...
const github_js_1 = require("./research/github.js");
const aggregator_js_1 = require("./research/aggregator.js");
...
program
    ...
    const spinner = (0, ora_1.default)('GitHub에서 Claude Code 생태계 트렌드를 조사 중...').start();
    try {
        spinner.text = 'GitHub API에서 저장소 정보를 수집 중...';
        const { results: repoMap, success } = await (0, github_js_1.fetchAllTrends)();
        spinner.text = '데이터를 집계하고 카테고리별로 분류 중...';
        const result = (0, aggregator_js_1.aggregateResults)(repoMap, !success);
        ...
        const reportPath = await (0, generator_js_1.writeReport)(result, options.output, options.open);
